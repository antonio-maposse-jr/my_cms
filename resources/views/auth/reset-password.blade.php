...
@section('content')
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        <a href="{{ route('front.home') }}" class="mb-12">
            <img alt="Logo" src="{{ asset('assets/image/infyom-logo.png') }}" height="85px" width="85px"/>
        </a>
            ...
            @csrf
                ...
                <div class="fv-row mb-10">
                    ...
                    <input id="email" class="form-control form-control-lg form-control-solid" value="{{ old('email', $request->email) }}"
                           type="email" name="email" required autocomplete="off" placeholder="Email" autofocus/>
