...
<script id="actionsPageTemplates" type="text/x-jsrender">
    ...
    <a href="#" data-id="{{:id}}" class="delete-page-btn btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                        <span class="svg-icon svg-icon-3">
...
<script id="pageVisibilityTemplate" type="text/x-jsrender">
  <label class="form-check form-switch form-check-custom form-check-solid form-switch-sm">
         <input name="status" data-id="{{:id}}" class="form-check-input visibility" type="checkbox" value="1" {{:checked}} >
