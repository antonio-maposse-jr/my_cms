                            ...
                            <div class="news-details">
                                ...
                                <div class="news-content-img position-relative">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        @else
                                            <iframe src="{{ $postDetail->postVideo->video_embed_code }}" frameborder="1" width="650" height="440" id="embed_video_i_frame" class="mt-5 col-12"></iframe>
                                        @endif
                                    </div>
                                            ...
                                            <div class="media-body comment-content w-100">
                                                <div class="media-title d-flex flex-wrap justify-content-between">
                                                    ...
                                                    @if(Auth::check() && $comment->user_id == getLogInUser()->id)
                                                        <button class="delete-btn fs-14 text-danger delete-comment-btn" data-id="{{$comment['id']}}"><i class="fa fa-trash-can"></i> {{ __('messages.delete') }}</button>
                                                    @endif
                                                </div>
